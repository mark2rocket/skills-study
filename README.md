...
이 프로젝트는 Claude 스킬을 사용하여 개발 및 마케팅 워크플로우를 자동화하는 방법을 학습하고 실습하기 위한 레포지토리입니다.
...
Claude 스킬을 활용하여 다양한 워크플로우를 자동화하는 방법을 학습합니다:
...
| 스킬 | 설명 | 사용법 |
|------|------|--------|
| **content-creator** | 마케팅 콘텐츠 생성 | `/content-creator` |
| **seo-optimizer** | SEO 최적화 및 분석 | `/seo-optimizer` |
| **social-media-manager** | 소셜 미디어 관리 | `/social-media-manager` |
| **marketing-analytics** | 마케팅 성과 분석 | `/marketing-analytics` |
| **copywriter** | 광고 카피 작성 | `/copywriter` |
| **competitor-analyzer** | 경쟁사 분석 | `/competitor-analyzer` |
...
1. `/seo-optimizer --keyword-research`로 키워드 조사
2. `/content-creator`로 블로그 콘텐츠 생성
3. `/seo-optimizer`로 SEO 최적화
4. `/social-media-manager`로 홍보 포스트 작성

#### 예제 4: 제품 런칭 캠페인

1. `/competitor-analyzer`로 시장 조사
2. `/copywriter`로 랜딩 페이지 카피 작성
3. `/social-media-manager`로 소셜 미디어 일정 생성
4. `/content-creator`로 이메일 시퀀스 작성
5. `/marketing-analytics`로 성과 추적 설정
